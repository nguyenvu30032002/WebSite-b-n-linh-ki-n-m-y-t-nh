                        ...
                        <WrapperOrder>
                         {
                          product.inventory > 0 ? (
                            ...
                            <>
                              <Button className='OrderProduct' type="primary" style={{cursor: 'not-allowed'}}>Hết hàng</Button>
                              <Button className='cartProduct' type="primary" danger style={{cursor: 'not-allowed'}}><FontAwesomeIcon icon={faCartShopping}/></Button>
                            </>
                          )
                         }
                        </WrapperOrder>
