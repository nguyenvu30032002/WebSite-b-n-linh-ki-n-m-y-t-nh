...
const ArticleComponent = () => {
  ...
  const products = [
    ...
    { id: 3, name: 'Chuột Gaming Logitech G102', origin: 'China', brand: 'Logitech', newPrice: '499.000', oldPrice: '599.000', sold: '300+', inventory: '200+', img: img, },
    { id: 4, name: 'Bàn phím cơ Corsair K70 RGB', origin: 'USA', brand: 'Corsair', newPrice: '2.999.000', oldPrice: '3.499.000', sold: '150+', inventory: '75+', img: img, },
    { id: 5, name: 'Tai nghe SteelSeries Arctis 7', origin: 'USA', brand: 'SteelSeries', newPrice: '3.999.000', oldPrice: '4.299.000', sold: '120+', inventory: '60+', img: img, },
    { id: 6, name: 'Màn hình LG UltraWide 34WP500', origin: 'Korea', brand: 'LG', newPrice: '7.999.000', oldPrice: '8.999.000', sold: '90+', inventory: '30+', img: img, },
    { id: 7, name: 'Case máy tính NZXT H510', origin: 'USA', brand: 'NZXT', newPrice: '2.499.000', oldPrice: '2.999.000', sold: '80+', inventory: '40+', img: img, },
    { id: 8, name: 'Card đồ họa MSI RTX 3080', origin: 'Taiwan', brand: 'MSI', newPrice: '29.999.000', oldPrice: '32.999.000', sold: '60+', inventory: '25+', img: img, },
    { id: 9, name: 'SSD Samsung 970 EVO Plus 1TB', origin: 'Korea', brand: 'Samsung', newPrice: '3.199.000', oldPrice: '3.499.000', sold: '150+', inventory: '100+', img: img, variants : true },
    { id: 10, name: 'Nguồn Corsair RM750x', origin: 'USA', brand: 'Corsair', newPrice: '2.999.000', oldPrice: '3.199.000', sold: '70+', inventory: '35+', img: img, }
  ];
